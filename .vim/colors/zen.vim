...
hi Normal          ctermfg=188 guifg=#dcdccc guibg=#3f3f3f
...
hi SpellBad        ctermfg=167 ctermbg=235 cterm=underline 
hi SpellCap        ctermfg=12 ctermbg=235 cterm=underline
hi SpellRare       ctermfg=13 ctermbg=235 cterm=underline
hi SpellLocal      ctermfg=14 ctermbg=235 cterm=underline
